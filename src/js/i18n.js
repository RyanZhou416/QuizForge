const translations = {
  zh: {
    ...
    seconds: "秒",
    close_bank: "关闭题库",
    close_bank_confirm: "确定要关闭当前题库吗？",
    bank_closed: "题库已关闭",
    delete_bank: "删除",
    delete_bank_confirm: "确定要从列表中移除该题库吗？",
    bank_deleted: "题库已移除",
    export_progress: "导出进度",
    import_progress: "导入进度",
    progress_exported: "进度已导出",
    progress_imported: "进度已导入",
    progress_import_error: "导入失败，文件格式错误",
    reset_confirm_with_export: "确定要重置所有进度吗？建议先「导出进度」备份。此操作不可撤销。",
    no_progress: "暂无进度数据",
  },
  en: {
    ...
    close_bank_confirm: "Close the current quiz bank?",
    bank_closed: "Bank closed",
    delete_bank: "Remove",
    delete_bank_confirm: "Remove this bank from the list?",
    bank_deleted: "Bank removed",
    export_progress: "Export Progress",
    import_progress: "Import Progress",
    progress_exported: "Progress exported",
    progress_imported: "Progress imported",
    progress_import_error: "Import failed, invalid file format",
    reset_confirm_with_export: "Reset all progress? Consider exporting a backup first. This cannot be undone.",
